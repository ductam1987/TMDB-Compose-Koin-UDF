...
val movieDetailFakeData = MovieDetail(
    ...
    budget = 190000000,
    genres = arrayListOf(Genre(id = 28, name = "Action"), Genre(id = 12, name = "Adventure"), Genre(id = 878, name = "Science Fiction")),
    ...
    vote_count = 1379,
    production_countries = arrayListOf(ProductCountries(iso_3166_1 = "US", name = "United States of America"))
)
